...
urlpatterns = [
    ...
    path("@<handle>/rss/timeline/home/", identity.TimelineFeed("home")),
    path("@<handle>/rss/timeline/local/", identity.TimelineFeed("local")),
    path("@<handle>/rss/timeline/federated/", identity.TimelineFeed("federated")),
